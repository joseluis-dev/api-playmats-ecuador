...
public class ShippingAddressSearchCriteria implements Specification<ShippingAddress> {
    private final List<SearchStatement> list = new LinkedList<>();
    public void add(SearchStatement criteria) { list.add(criteria); }

    @SuppressWarnings("null")
    @Override
    public Predicate toPredicate(Root<ShippingAddress> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
