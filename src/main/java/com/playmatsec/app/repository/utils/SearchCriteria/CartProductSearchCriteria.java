...
public class CartProductSearchCriteria implements Specification<CartProduct> {
    private final List<SearchStatement> list = new LinkedList<>();
    public void add(SearchStatement criteria) { list.add(criteria); }
    
    @SuppressWarnings("null")
    @Override
    public Predicate toPredicate(Root<CartProduct> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
