...
public class CountriesController {
  ...
  public ResponseEntity<Country> getCountryById(@RequestHeader Map<String, String> headers, @PathVariable String id) {
    log.info("headers: {}", headers);
  ...
  public ResponseEntity<Boolean> deleteCountryById(@RequestHeader Map<String, String> headers, @PathVariable String id) {
    log.info("headers: {}", headers);
  ...
  public ResponseEntity<Country> createCountry(@RequestHeader Map<String, String> headers, @RequestBody CountryDTO country) {
    log.info("headers: {}", headers);
  ...
  public ResponseEntity<Country> updateCountry(@RequestHeader Map<String, String> headers, @PathVariable String id, @RequestBody String patchBody) {
    log.info("headers: {}", headers);
  ...
  public ResponseEntity<Country> replaceCountry(@RequestHeader Map<String, String> headers, @PathVariable String id, @RequestBody CountryDTO country) {
    log.info("headers: {}", headers);
